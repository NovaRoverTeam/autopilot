...
class ConvertDist2GPSCoord:# =================================================================================
    ...
    @staticmethod 
    def DeltaGPSCoord(bearing, distance, distPerDegLatitude, distPerDegLongitude):     
        ...
        deltaLatitudeGPS = deltaLatitude/distPerDegLatitude
        deltaLongitudeGPS = deltaLongitude/distPerDegLongitude
    ...
    def DetermineDestGPSCoord(bearing, distance, currentRoverLat, currentRoverLong): 
        ...
        if(bearing>=0 and bearing<=90): #quadreant 1 #NOTE: distance of conversion is in meters
            deltaLatitude, deltaLongitude = ConvertDist2GPSCoord.DeltaGPSCoord(bearing, distance, distPerDegLat, distPerDegLong)
    ...
    if(req.latlng== True): # call route through graph 
        ...
        if(currentRoverLat < lat1MonashSelected and currentRoverLat > lat2MonashSelected and currentRoverLong > long1MonashSelected and currentRoverLong < long2MonashSelected ):
            ...
            for i in range(0,len(gpsRoute),2):
                ...
                rospy.loginfo("Route: %f", gpsRoute)
